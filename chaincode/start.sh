...
echo "二、安装链码"
./network.sh deployCC -ccn cc_scf_3 -ccp ../chaincode/chaincode-new -ccl go
...
echo "四、初始化链码'"
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"Init","Args":[]}' 
sleep 5
echo "当前账户列表"
peer chaincode query -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"QueryAccountaById","Args":[""]}'

echo "五、创建一个资产"
export Ticket_PROPERTIES=$(echo -n "{\"price\":\"101\",\"fromOrder\":\"ccccit\"}" | base64 | tr -d \\n)
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"CreateTicket","Args":[ "A new 002 ticket for Org1MSP"]}' --transient "{\"ticket_properties\":\"$Ticket_PROPERTIES\"}"
sleep 5
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"CreateTicket","Args":[ "A new 001 ticket"]}' --transient "{\"ticket_properties\":\"$Ticket_PROPERTIES\"}"
sleep 5
...
echo "六、查询票据"  WD8F2qNfHK   BpLnfgDsc2  5a84jjJkwz Dkh9h2fhfU
echo "6.1 票据公开数据"
peer chaincode query -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"QueryTicket","Args":["BpLnfgDsc2"]}'
echo "6.2 票据隐私数据"
peer chaincode query -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"ReadTicketPrivateProperties","Args":["WD8F2qNfHK"]}'
echo "6.3 查询所有数据"
peer chaincode query -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"GetAllTicket","Args":[""]}'

echo "七、 更改票据备注"
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"ChangeDescription","Args":["WD8F2qNfHK","new01"]}'
sleep 5

echo "八、 转让票据"
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n scf -c '{"function":"TransferTicket","Args":["WD8F2qNfHK","Org2MSP"]}' --transient "{\"ticket_properties\":\"$Ticket_PROPERTIES\"}" --peerAddresses localhost:7051 --tlsRootCertFiles "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt" --peerAddresses localhost:9051 --tlsRootCertFiles "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt"
sleep 5
echo "转让后票据公开信息依然可查看"
